...
x0 = np.array([-2, 2])
result = gradient_descent(rosenbrock, rosenbrock_grad, x0, max_iter = 2000)
...
plt.tight_layout()
plt.savefig(f"examples/rosenbrock_gradient_descent_path_start{x0}.png", dpi=150, bbox_inches="tight")
plt.show()