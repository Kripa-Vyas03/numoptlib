...
for x0 in ([[-1, 1], [0, 0], [-1.1, 1]]):
    x0 = np.array(x0)
    result = adams_gradient_descent(rosenbrock, rosenbrock_grad, x0, alpha = 0.1, max_iter = 2000)
    print(f"-- Start: {x0} --")
...
result1 = adams_gradient_descent(rosenbrock, rosenbrock_grad, x0, alpha = 0.01,  max_iter=10000)
result2 = adams_gradient_descent(rosenbrock, rosenbrock_grad, x0, alpha = 0.1, max_iter=10000)
result3 = adams_gradient_descent(rosenbrock, rosenbrock_grad, x0, alpha = 0.5, max_iter=10000)
...
plt.tight_layout()
plt.savefig("rosenbrock_gradient_descent_comparingalphas.png", dpi=150, bbox_inches="tight")
plt.show()